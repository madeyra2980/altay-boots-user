    ...
    <div className="mx-auto max-w-5xl px-4 py-16 md:px-6 lg:px-8">
      <div className="space-y-12">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {/* Company Info Card */}
          <div className="rounded-2xl bg-gradient-to-br from-rose-50 to-orange-50 p-8 shadow-lg">
            <div className="mb-6 flex items-center gap-4">
              {company?.photoURL && (
                <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border-4 border-white shadow-md">
                  <img
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {company?.text || 'Качественная обувь'}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {company?.city && company?.base && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{company.city}, {company.base}</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+77770000000" className="text-rose-600 hover:text-rose-700">
                    +7 777 000 00 00
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:hello@altayboots.kz" className="text-rose-600 hover:text-rose-700">
                    hello@altayboots.kz
                  </a>
                </div>
              </div>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-lg">
            <h2 className="mb-6 text-2xl font-bold text-gray-900">Часы работы</h2>
            
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                <span className="font-medium text-gray-700">Понедельник - Пятница</span>
              ...
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                <span className="font-medium text-gray-700">Воскресенье</span>
                <span className="text-gray-900">10:00 - 16:00</span>
              </div>
            </div>

            <div className="mt-8 rounded-xl bg-gradient-to-r from-rose-600 to-orange-600 p-6 text-white">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 p-8 text-center shadow-lg">
          <h2 className="mb-4 text-2xl font-bold text-gray-900">Мы в социальных сетях</h2>
          <p className="mb-6 text-gray-600">Следите за новинками и акциями</p>
          
          <div className="flex justify-center gap-4">
            <a href="#" className="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md transition hover:scale-110 hover:shadow-lg">
